    ...
    public partial class BL
    {
        public IEnumerable<TypeDoc> GetTypeDoc()
        {
            return [
                     ...
                     new TypeDoc() { Group = eGroup.Price, CodeDoc = 0, NameDoc = "Прайсчекер" , KindDoc = eKindDoc.PriceCheck,IsOffLine=true},
                     new TypeDoc() { Group = eGroup.Price, CodeDoc = 15, NameDoc = "Подвійний сканер" , KindDoc = eKindDoc.PriceCheck},
                     new TypeDoc() { Group = eGroup.Price, CodeDoc = 16, NameDoc = "Пропозиція акцій" , KindDoc = eKindDoc.PriceCheck, LevelReason=16},
                     ...
                     new TypeDoc() { Group = eGroup.Doc, CodeDoc = 1, NameDoc = "Ревізія", TypeControlQuantity = eTypeControlDoc.Ask, IsSaveOnlyScan=false, KindDoc = eKindDoc.Normal ,IsViewAct=true ,IsNotViewPlanF4=true, IsAddAuto=true },
                     ...
                     new TypeDoc() { Group = eGroup.Doc, CodeDoc = 3, NameDoc = "Переміщення Вих", TypeControlQuantity=eTypeControlDoc.NoControl, KindDoc = eKindDoc.Normal, TypeCreateDoc=eTypeCreateDoc.Warehouse, IsAddAuto=true },
                     new TypeDoc() { Group = eGroup.Doc, CodeDoc = 4, NameDoc = "Списання" ,  KindDoc = eKindDoc.Normal, TypeCreateDoc=eTypeCreateDoc.Nothing, IsAddAuto=true},
                     new TypeDoc() { Group = eGroup.Doc, CodeDoc = 5, NameDoc = "Повернення" ,  KindDoc = eKindDoc.Normal, TypeCreateDoc=eTypeCreateDoc.Nothing, IsAddAuto=true},
                     new TypeDoc() { Group = eGroup.Doc, CodeDoc = 8, NameDoc = "Переміщення Вх", TypeControlQuantity=eTypeControlDoc.Ask, IsViewOut=true, IsViewReason=true,KindDoc = eKindDoc.Normal, IsAddAuto=true },
